	...
	@if ( !$contactos->count())
        ...
        @else
                <dl>
					...
					(
                            		{!! link_to_route('contactos.edit', Lang::get('messages.edit'), array($contacto->slug), array('class' => 'btn btn-info')) !!},
        ...
        @endif
	<p>
		{!! link_to_route('contactos.create', Lang::get('messages.createContacts')) !!}<br/><br/>
